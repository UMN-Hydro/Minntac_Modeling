...
%     use_file_databas = '/home/gcng/Documents/Teaching/ESCI5980_HydModeling/Fall2015/Lectures/L16_PHT3D_2/PHT3D_files/pht3d_datab.dat';
    ...
    % - sim_dir: Directory with input files and where you run simulations
    sim_dir = 'C:\Hydro_Modeling\GW004_pht3d_dir\';

    % - flo_file: MODFLOW flo simulation file (full path)
    % flo_file = '/home/gcng/workspace/ModelRuns_scratch/MODFLOW_projects/ESCI5980/test2_1D_3/test.flo';
    flo_file = 'C:\Hydro_Modeling\MINNTAC_MATLAB_FILES\GW004_MODFLOW_dir\test.flo'; % 2D, no recharge
...
% -- General properties
tempC = 6.25; % water temperature, geochem rxs are temp-sensitive
por = 0.35;   % porosity
...
[mob_eq_comp, mob_eq_ic_z, mob_eq_extra_z, min_eq_comp, min_eq_ic_z, catex_comp, catex_ic_z, ...
    ...
    GW004_Minntac_InitCond_chem_red_wFeS(sim_dir, phrq_exe, use_file_databas, por, tempC);
...
for ii = 1: n_mob_eq
    ...
    mob_eq_distr_rech(1,1:round(375/x_scale),ii) = mob_eq_ic_z(4,ii); % recharge concentration thru perimeter dike
end
for ii = 1: n_min_eq
    % Rest of domain
...
imob_kin_ic(:,1:round(150/x_scale),1:round(62/y_scale),ii) = 0;
imob_kin_ic(:,round(150/x_scale):round(225/x_scale),1:round(88/y_scale),ii) = 0;
imob_kin_ic(:,round(225/x_scale):round(375/x_scale),1:round(62/y_scale),ii) = 0;
