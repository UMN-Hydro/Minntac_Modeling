function [mob_eq_comp, mob_eq_ic_z, mob_eq_extra_z, min_eq_comp, min_eq_ic_z, ...
    ...
    MW12_Minntac_InitCond_chem_red(phrq_sim_dir, phrq_exe, use_file_databas, por, tempC) 
...
% fl_gcng = 1; % 1 for gcng, 0 for Patrick
% if fl_gcng
...
pH = 6.92;
zz = 0;
zz = zz + 1; mob_eq_obs_z(zz,ii) = 0; %Alk2DIC(3*5.19/1000, pH, Ka1, Ka2, KH); % meq/L  
zz = zz + 1; mob_eq_obs_z(zz,ii) = 0; %Alk2DIC(3*5.19/1000, pH, Ka1, Ka2, KH); % meq/L  
zz = zz + 1; mob_eq_obs_z(zz,ii) = 0; %Alk2DIC(3*5.19/1000, pH, Ka1, Ka2, KH); % meq/L  
...
zz = 0;
zz = zz + 1; mob_eq_obs_z(zz,ii) = 6.89; % mg/L 'charge' denotes will balance with anions
mob_eq_extra_z{zz,ii} = 'charge';
zz = zz + 1; mob_eq_obs_z(zz,ii) = 0; % mg/L
mob_eq_extra_z{zz,ii} = 'charge';
zz = zz + 1; mob_eq_obs_z(zz,ii) = 0; % mg/L
...
zz = 0;
zz = zz + 1; mob_eq_obs_z(zz,ii) = 10; % mg/L DO  
